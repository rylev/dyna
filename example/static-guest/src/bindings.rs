...
pub mod component {
  pub mod example {
    ...
    pub mod baz {
      ...
      #[derive(Clone)]
      pub struct Bar {
        pub field: wit_bindgen::rt::vec::Vec::<u8>,
      }
      ...
      pub mod foo {
        ...
        const _: () = {
          ...
          unsafe extern "C" fn __export_hello_world() -> i32 {
            ...
            let result0 = <_GuestImpl as Guest>::hello_world();
            let ptr1 = _RET_AREA.0.as_mut_ptr() as i32;
            let super::super::super::super::component::example::baz::Bar{ field:field2, } = result0;
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 305] = [0, 97, 115, 109, 13, 0, 1, 0, 0, 25, 22, 119, 105, 116, 45, 99, 111, 109, 112, 111, 110, 101, 110, 116, 45, 101, 110, 99, 111, 100, 105, 110, 103, 4, 0, 7, 180, 1, 1, 65, 2, 1, 65, 7, 1, 66, 3, 1, 112, 125, 1, 114, 1, 5, 102, 105, 101, 108, 100, 0, 4, 0, 3, 98, 97, 114, 3, 0, 1, 3, 1, 21, 99, 111, 109, 112, 111, 110, 101, 110, 116, 58, 101, 120, 97, 109, 112, 108, 101, 47, 98, 97, 122, 5, 0, 1, 64, 0, 0, 115, 4, 0, 11, 104, 101, 108, 108, 111, 45, 119, 111, 114, 108, 100, 1, 1, 2, 3, 0, 0, 3, 98, 97, 114, 1, 66, 4, 2, 3, 2, 1, 2, 4, 0, 3, 98, 97, 114, 3, 0, 0, 1, 64, 0, 0, 1, 4, 0, 11, 104, 101, 108, 108, 111, 45, 119, 111, 114, 108, 100, 1, 2, 4, 1, 21, 99, 111, 109, 112, 111, 110, 101, 110, 116, 58, 101, 120, 97, 109, 112, 108, 101, 47, 102, 111, 111, 5, 3, 4, 1, 25, 99, 111, 109, 112, 111, 110, 101, 110, 116, 58, 101, 120, 97, 109, 112, 108, 101, 47, 101, 120, 97, 109, 112, 108, 101, 4, 0, 11, 13, 1, 0, 7, 101, 120, 97, 109, 112, 108, 101, 3, 0, 0, 0, 70, 9, 112, 114, 111, 100, 117, 99, 101, 114, 115, 1, 12, 112, 114, 111, 99, 101, 115, 115, 101, 100, 45, 98, 121, 2, 13, 119, 105, 116, 45, 99, 111, 109, 112, 111, 110, 101, 110, 116, 6, 48, 46, 50, 49, 46, 48, 16, 119, 105, 116, 45, 98, 105, 110, 100, 103, 101, 110, 45, 114, 117, 115, 116, 6, 48, 46, 49, 56, 46, 48];
